...
extension LooiCommand {
    ...
    public enum Movement {
        public nonisolated static let forwardMax: Data    = encode(speed:  127, turn:    0)
        public nonisolated static let backwardMax: Data   = encode(speed: -127, turn:    0)
        public nonisolated static let spinLeftMax: Data   = encode(speed:    0, turn:  127)
        public nonisolated static let spinRightMax: Data  = encode(speed:    0, turn: -127)
        public nonisolated static let stop: Data          = encode(speed:    0, turn:    0)
        ...
        public nonisolated static func encode(speed: Int8, turn: Int8) -> Data {
            Data([UInt8(bitPattern: speed), UInt8(bitPattern: turn)])
        }

        /// Build from a normalized [-1.0, 1.0] joystick value. Clamps out of range.
        public nonisolated static func normalized(forward: Double, turn: Double) -> Data {
