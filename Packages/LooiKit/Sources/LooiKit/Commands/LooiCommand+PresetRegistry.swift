...
extension LooiCommand {
    ...
    public nonisolated static let allPresets: [Preset] = [
        ...
        Preset(label: "Head — look down hold (0xB0)",
               source: "andrey-tut+M0.5", status: .verified,
               characteristic: LooiProtocol.Char.head, bytes: Head.lookDown,
               note: "Non-extreme down pitch intended to hold better than 0xFF."),
        Preset(label: "Head — nod down (0xFF, auto-returns)",
               source: "andrey-tut+M0.5", status: .verified,
               characteristic: LooiProtocol.Char.head, bytes: Head.nodDown,
        ...
        // 3. Light
        Preset(label: "Light — full (0xFE)",
               source: "M0.5+DevTools", status: .verified,
               characteristic: LooiProtocol.Char.light, bytes: Light.full,
               note: "App-level full avoids 0xFF after real-device DevTools testing showed 0xFF can be non-visible."),
